  ...
  if (offsetObjdict)
    {
      ...
      while (offsetObjdict <= lastIndex)
        {
//			print_ch(CH_TTY1,"% s PDO 0x%X N sub:%X state: %u  \n\r",__FUNCTION__,  d->objdict[offsetObjdict].index, d->objdict[offsetObjdict].bSubCount,status);		
